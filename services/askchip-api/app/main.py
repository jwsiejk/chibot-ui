...
def create_app(config: Settings = settings, ollama_transport=None, webrtc_peer_factory=None, stt_service=None, tts_adapter=None) -> FastAPI:
    ...
    def get_config() -> JSONResponse:
        ...
        payload = ConfigResponse(
            ...
            tts_requested_device=str((tts_runtime.get('requested_device') if tts_runtime else config.tts_device)),
            ...
            tts_available_providers=list((tts_runtime.get('available_providers') if tts_runtime else [])),
            tts_warning=(str(tts_runtime.get('warning')) if tts_runtime and tts_runtime.get('warning') else None),
            tts_fallback_reason=(str(tts_runtime.get('fallback_reason')) if tts_runtime and tts_runtime.get('fallback_reason') else None),
