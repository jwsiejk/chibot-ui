...
export const buildChappySystemInstruction = (mode: SessionMode): string =>
  [
    ...
    'Default to concise spoken responses: 2–4 short sentences, roughly 40–90 words.',
    ...
    'If a response could become long, give the short spoken version first and offer to go deeper.',
