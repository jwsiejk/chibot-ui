...
export type AssistantRuntimeProviderMetadata = {
  provider: 'ollama_local';
  model: string;
  base_url: string;
};

export type AssistantRuntimeSuccess = {
  ok: true;
  text: string;
  runtime: AssistantRuntimeProviderMetadata;
};
...
export type AssistantRuntimeError = {
  ok: false;
  code: AssistantRuntimeErrorCode;
  message: string;
  runtime: AssistantRuntimeProviderMetadata;
};
