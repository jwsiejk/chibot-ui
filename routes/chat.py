...
chat_bp = Blueprint("chat_bp", __name__)  # _register_bp assigns the prefix

def _norm(s: str) -> str:
    return (s or "").strip().lower()

# Bind both /api/chat and /api/chat/ (depending on how your client calls it)
...
def chat():
    ...
    # Additional server-side guard (in case a model ever echoes)
    if _norm(reply) == _norm(user_text):
        ...
        reply = "I hear you. Can you tell me a bit more about what you want help with?"
