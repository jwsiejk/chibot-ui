...
describe('phase 22 chappy UI', () => {
  ...
  it('start open q&a creates local session and navigates to session shell', () => {
    ...
    const topBar = screen.getByLabelText('top meeting bar');
    ...
    expect(screen.getByText('vChappy is ready')).toBeInTheDocument();
    expect(screen.getByText('vChappy is ready')).toHaveClass('stage-status-pill');
