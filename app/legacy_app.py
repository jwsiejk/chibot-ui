...
def create_app():
    ...
    # Accounts search (CSV/DB-backed)
    _register("routes.accounts", "accounts_bp", url_prefix=None)

    # Email send webhook proxy
    _register("routes.email_api", "email_bp", url_prefix=None)
